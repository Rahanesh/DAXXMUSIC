...
GALI =  ['مَاهْدارچود تِری ماکی کی چوت مِ گهوتکا کھاکه تهوک دونگا 🤣🤣",
    "مادرچود تری می کنی که من قوی ترم 🤣🤣",
"بهترین چیزها به قهرمان دیگر هیچ کس نمی‌تواند دستر خورده باشد",
